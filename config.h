...
static const char *templatecmd[] = { "$HOME/.scripts/templates.sh", "$HOME/workspace/default_files", NULL };
...
static Key keys[] = {
	...
	{ MODKEY,                       XK_space,  spawn,          SHCMD("urxvt -c \"xmodmap ~/.Xmodmap\"") },
	{ MODKEY|ShiftMask,             XK_space,  togglefloating, {0} },
	{ MODKEY|ShiftMask,             XK_Print,  spawn,          SHCMD("import ~/Pictures/$(printf 'Screenshot from %s %s.png' $(date +'%y-%m-%d %H-%M-%S'))") },
    ...
    { MODKEY,                       XK_KP_2,   spawn,          SHCMD("$BROWSER") },
...
//	{ 0, XK_XF86AudioMute,          spawn,      SHCMD("amixer -D pulse sset Master 0%") },
